...
Принимает запросы по REST вида: POST api/v1/wallet { walletId: UUID, operationType: DEPOSIT or WITHDRAW, amount: 1000}.
После выполняется логика по изменению счета в БД с возможностью получения баланса кошелька: GET api/v1/wallets/{WALLET_UUID}.
